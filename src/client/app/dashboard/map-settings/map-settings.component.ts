	...
	ngOnInit() {
        ...
        snowDepth.highcharts({
            ...
            series: [{
                ...
                data: [
                    [Date.UTC(2016, 10, 25), 0],
                    [Date.UTC(2016, 11, 6), 0.25],
                    [Date.UTC(2016, 11, 20), 1.41],
                    [Date.UTC(2016, 11, 25), 1.64],
                    [Date.UTC(2017, 0, 4), 1.6],
                    [Date.UTC(2017, 0, 17), 2.55],
                    [Date.UTC(2017, 0, 24), 2.62],
                    [Date.UTC(2017, 1, 4), 2.5],
                    [Date.UTC(2017, 1, 14), 2.42],
                    [Date.UTC(2017, 2, 6), 2.74],
                    [Date.UTC(2017, 2, 14), 2.62],
                    [Date.UTC(2017, 2, 24), 2.6],
                    [Date.UTC(2017, 3, 2), 2.81],
                    [Date.UTC(2017, 3, 12), 2.63],
                    [Date.UTC(2017, 3, 28), 2.77],
                    [Date.UTC(2017, 4, 5), 2.68],
                    [Date.UTC(2017, 4, 10), 2.56],
                    [Date.UTC(2017, 4, 15), 2.39],
                    [Date.UTC(2017, 4, 20), 2.3],
                    [Date.UTC(2017, 5, 5), 2],
                    [Date.UTC(2017, 5, 10), 1.85],
                    [Date.UTC(2017, 5, 15), 1.49],
                    [Date.UTC(2017, 5, 23), 1.08]
                ]
            }]
        });
	}
